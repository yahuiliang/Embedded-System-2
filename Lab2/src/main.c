 ...
 * its signature at the top of the file (This is a little complex). Most logic
 ...
 * one logic. This is why this C program has less lines than the original version.
 * However, there are many syntax problems we should be careful. Since assembly just
